...
namespace data.uows
{
    public class BlogUnitOfWork
    {
        ...
        private Repository<HAVADURUMU> _HAVADURUMURepository;
        public Repository<HAVADURUMU> HAVADURUMURepository {
            get {
                if (_HAVADURUMURepository == null) {
                    _HAVADURUMURepository = new Repository<HAVADURUMU>(_context);
                }
                return _HAVADURUMURepository;
            }
        }
